  ...
  def recording_ready
    ...
    begin
      ...
      if signed_params[:meeting_id] == @conference.conference_key
        # Send an API request to our website to pull the recording
        customparams = { body: { server_name: HostUrl.default_host, record_id: signed_params[:record_id], server_url: @conference.config[:domain], shared_secret: secret } }
        HTTParty.post("https://sapienslab.com.mx/api/recording_ready.php", customparams)
